...
class HTMLPage extends Page
{
    ...
    /**
     * The generate function calls the `build()` function before appending
     ...
     *
     * @see toolkit.General#arrayFindAvailableIndex()
    ...
    public function addElementToHead(XMLElement $object, $position = null, $allowDuplicate = true)
    {
        ...
        if (($position && isset($this->_head[$position]))) {
            $position = General::arrayFindAvailableIndex($this->_head, $position);
     ...
     * @return string
     */
    public function buildQueryString(array $exclude = array())
    {
        $exclude[] = 'page';
