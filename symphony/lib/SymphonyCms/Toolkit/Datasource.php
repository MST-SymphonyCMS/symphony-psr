...
use \SymphonyCms\Datasources\AuthorDatasource;
use \SymphonyCms\Datasources\SectionDatasource;
use \SymphonyCms\Datasources\StaticDatasource;
use \SymphonyCms\Datasources\DynamicXmlDatasource;
use \SymphonyCms\Datasources\NavigationDatasource;
...
class DataSource
{
     ...
     */
    public function determineFilterType($value)
    {
    ...
    {
        return new XMLElement('error', tr('No records found.'));
    }
    ...
    public function processParameters(array $env = null)
    {
        ...
        if (isset($this->dsParamREQUIREDPARAM)
