...
class ResourceManager
{
     ...
     */
    public static function getExtensionFromHandle($type, $r_handle)
    {
        $manager = self::getManagerFromType($type);
        ...
        preg_match('/^extensions\/(.*)\/' . $type . '/', call_user_func(array($manager, 'getClassPath'), $r_handle), $data);
 ...
 * @var integer
 */
defineSafe('RESOURCE_TYPE_EVENT', 20);

/**
 * The integer value for datasource-type resources.
 * @var integer
 */
defineSafe('RESOURCE_TYPE_DS', 21);
