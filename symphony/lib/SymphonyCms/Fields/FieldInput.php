 ...
 */
class FieldInput extends Field implements ExportableFieldInterface, ImportableFieldInterface
{
    public function __construct()
    {
        parent::__construct();

        $this->_name = tr('Text Input');
        $this->_required = true;
    ...
    private function applyValidationRules($data)
    {
