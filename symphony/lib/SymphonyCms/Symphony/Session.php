    ...
    public static function start($lifetime = 0, $path = '/', $domain = null, $httpOnly = true, $secure = false)
    {
        if (!self::$_initialized) {
            ...
            session_set_save_handler(
                array('\\SymphonyCms\\Symphony\\Session', 'open'),
                array('\\SymphonyCms\\Symphony\\Session', 'close'),
                array('\\SymphonyCms\\Symphony\\Session', 'read'),
                array('\\SymphonyCms\\Symphony\\Session', 'write'),
                array('\\SymphonyCms\\Symphony\\Session', 'destroy'),
                array('\\SymphonyCms\\Symphony\\Session', 'gc')
            );
