<?php
	...
	-------------------------------------------------------------------------*/
		...
		public function displaySettingsPanel(XMLElement &$wrapper, $errors = null){
			...
			$label->setValue(tr('Limit to %s entries', array($input->generate())));
			...
			$label->setValue($input->generate() . ' ' . tr('Hide when prepopulated'));
			$div->appendChild($label);
			...
			$label->setValue($input->generate() . ' ' . tr('Allow selection of multiple options'));
		...
		public function checkFields(array &$errors, $checkForDuplicates = true) {
			...
			if(empty($related_fields)){
				$errors['related_field_id'] = tr('This is a required field.');
			}
	...
	-------------------------------------------------------------------------*/
		...
		public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null) {
			...
			if($this->get('required') != 'yes') $label->appendChild(new XMLElement('i', tr('Optional')));
			$label->appendChild(
